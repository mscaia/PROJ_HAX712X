...
::: fragment
<div style="text-align: center;">
[**Schéma des résultats attendus :**]{.custom-subtitle2}
<br>
<br>
...
# iframe
display(IFrame("map.html", width="950", height="450"))
```
</div>
...
::: {.column width="25%"}
<div style="text-align: center;">
<img src="images/perf_analys/5.png" width="100%" align="middle">
</div>
:::
::: {.column width="25%"}
<div style="text-align: center;">
<img src="images/perf_analys/6.png" width="100%" align="middle">
</div>
:::
:::
:::
...
1. **Gestion des données :**  
    - Problèmes avec les formats des données (json non formatés, csv ou dataframe) et les données manquantes.  

2. **Création de cartes interactives et prévisions de trafic :**  
    - Longueur en temps des créations de cartes.  
...
2.  🛠️ **Outils et Ressources**  
    ...
    - *Plateforme YouTube* : Des vidéos et tutoriels sur YouTube ont également été consultés afin de renforcer la compréhension de certaines étapes du projet et d'apprendre des pratiques pertinentes pour la mise en œuvre des visualisations interactives et l'intégration des fonctionnalités interactives.  
3. 🤝 **Contributions & Références** 
