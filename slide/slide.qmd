...
::: fragment
<div style="text-align: center;">
[**Analyse des trajets en 2022**]{.custom-subtitle3}
</div>
::: {.columns style="display: flex; justify-content: center;"}
::: {.column width="65%"}
<div style="text-align: center;">
<img src="images/analys_datasets/cell-2-output-2.png" width="63%" align="middle">
</div>
:::
::: {.column width="35%"}
<div style="text-align: center;">
<img src="images/ana_trage.png" width="60%" align="middle">
</div>
:::
:::
:::
...
::: {.column width="50%"}
<div style="text-align: center;">
<img src="images/analys_datasets/Distance_par_mois_2021_2024.png" width="85%" align="middle">
</div>
:::
:::
:::
...
::: {.column width="50%"}
<div style="text-align: center;">
<img src="images/charl_1_3.png" width="73%" align="middle">
</div>
:::
...
::: {.column width="50%"}
<div style="text-align: center;">
<img src="images/perf_analys/3.png" width="100%" align="middle">
</div>
:::
::: {.column width="50%"}
<div style="text-align: center;">
<img src="images/perf_analys/4.png" width="100%" align="middle">
</div>
:::
:::
...
1. **Gestion des données :**  
   - Problèmes avec les formats des données (JSON non formatés, CSV ou DataFrame).  
   - Importation et lecture des fichiers CSV, particulièrement complexes au début.  
   - Données manquantes nécessitant un traitement supplémentaire.  
2. **Création de cartes interactives et prévisions de trafic :**  
   - Temps de création élevé pour développer des cartes interactives.  
3. **Déploiement du site web :**  
   - Difficultés initiales lors du déploiement (GitHub Pages).  
   - Intégration des cartes interactives, notamment celles utilisant **Shiny**.  
   - Configuration des fonctionnalités interactives liées aux vidéos.  
4. **Documentation du projet :**  
   - Complexité liée au formatage clair et lisible d'un grand nombre de fonctions.  
...
4. **Compétences développées :**  
   ...
   - Configuration et automatisation CI/CD avec **GitHub Actions**.  
