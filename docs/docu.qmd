...
│   ├── update_and_deploy.yml                   #
├── Cycle3/                                     # Scripts pour l'analyse des données
│   ├── analyse_donnee/                         # Images utilisées dans le projet
│   │   ├── cache/
│   │   ├── __init__.py  
│   │   └── statistique.py
│   ├── docs/                                   #
...
│   ├── docu_files/
│   ├── index_files/
│   ├── projet1_files/figure-html/
│   ├── projet2_files/
│   ├── projet3_files/figure-html/
│   ├── shiny_app/
│   ├── site_libs/
...
├── roadmap/                                    # 
├── slide/                                      # 
│   ├── cache/                                  # Fonctions de traitement des données
│   ├── images/                                 # Fonctions pour les bases de données
│   ├── slide_files/libs/
│   ├── _metadata.yml
│   ├── map.html
│   ├── slide.css
