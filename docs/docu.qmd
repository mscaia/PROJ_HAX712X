...
![Image locale](docu_files/1.png) ![Image locale](docu_files/2.png)

*(Les graphiques sont présentés côte à côte)*
...
![Image locale](docu_files/3.png) ![Image locale](docu_files/4.png)  
![Image locale](docu_files/5.png) ![Image locale](docu_files/6.png)  
*(Les graphiques sont présentés deux par deux, côte à côte)*
...
2. Entrez l’adresse suivante : [https://mscaia.github.io/PROJ_HAX712X/].
3. Explorez les sections disponibles :

## 9.2 Téléchargement et traitement des données
1. Téléchargez les jeux de données sur la page X
2. Utilisez le menu pour :
...
## 9.5 Dépannage
Si vous rencontrez des problèmes n'hésitez pas à [nous contacter](auteurs.qmd).
