...
date_selector = widgets.Dropdown(
    ...
    value=Liste_des_dates[0],  # Première date par défaut
    description="Date:",
...
def update_map(change=None):
    with output:
        ...
        # Convertir la carte en HTML et l'afficher dynamiquement
        html = m._repr_html_()
        display(HTML(html))
...
# Afficher la première carte par défaut
update_map()
```
